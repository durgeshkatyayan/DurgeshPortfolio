...
export default function NewProjectPage() {
  ...
  const inputClass = "w-full rounded-xl border border-neutral-300 bg-transparent p-3.5 text-sm outline-none transition-all focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-neutral-700";
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {errors.techStack && <p className="text-red-500 text-xs mt-1.5">{errors.techStack.message}</p>}
          ...
          <div className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input {...register("githubUrl")} type="url" placeholder="https://github.com/your-username/repo" className={inputClass} />
              ...
              <div>
                ...
                <input {...register("liveUrl")} type="url" placeholder="https://your-project.com" className={inputClass} />
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="p-6">
              ...
              {errors.thumbnail && <p className="text-red-500 text-xs mt-2 text-center">{errors.thumbnail.message}</p>}
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-between rounded-xl border border-neutral-200 dark:border-neutral-700 p-4">
                <div>
                  <label htmlFor="featured" className="block text-sm font-bold text-neutral-900 dark:text-white cursor-pointer">
                    Feature Project
                  </label>
